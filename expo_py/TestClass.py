# -*- coding: utf-8 -*-
"""
Created on Wed Jul 18 20:56:19 2018
...
class Test:
    ...
    def tmapval(self,a, i, lin, rejli, rejrli):
    ...
    def feature_mapping(self,temp, tedf,lin, total, mingram,cfd, Xpd):
    ...
    #        print("bef",rejrli)
            ...
            tdf[str(i)].apply(self.tmapval, args = (i,lin, rejli, rejrli))
    ...
    def testmode(self,temp = tempor, lin = None,cfd = None,total=None, mingram=None, mode = "train"):
        if (mode != "feedback"):
    ...
    #    print(len(cfd['a0']))
    #    print(len(cfd['a1']))
        Xpd = self.feature_mapping(temp, tedf, lin, total, mingram,cfd, Xpd)
    ...
    #    Rejectedpd.to_csv("C:/Users/gsoun/LogCorruptionFinder/Rejected.csv")
        print(datetime.now() - self.Startime)
